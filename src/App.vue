                    ...
                    <div class="flex">
                        <div class="max-w-xs">
                            ...
                            <div class="mt-1 relative rounded-md shadow-md">
                                <input v-model="inputTicker" v-on:keydown.enter="add" type="text" name="wallet" id="wallet" class="block w-full pr-10 border-gray-300 text-gray-900 focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-sm rounded-md" placeholder="Например DOGE"/>
                            </div>
...
<!--                            <div class="text-sm text-red-600">Такой тикер уже добавлен</div>-->
                ...
                <template v-if="addedTickers.length">
                    ...
                    <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
                        ...
                        <div
                            ...
                            class="bg-white overflow-hidden shadow rounded-lg border-solid cursor-pointer border-4 border-transparent">
                            ...
                            <button v-on:click.stop="handlerDelete(item)" class="flex items-center justify-center font-medium w-full bg-gray-100 px-4 py-4 sm:px-6 text-md text-gray-500 hover:text-gray-600 hover:bg-gray-200 hover:opacity-20 transition-all focus:outline-none">
                ...
                <template v-if="selectTicker">
                    ...
                    <section class="relative">
                        ...
                        <button v-on:click="selectTicker = null" type="button" class="absolute top-0 right-0">
